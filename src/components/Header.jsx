...
export default function Header() {
    return (
        <div id="header-container" className="flex justify-between items-center p-4 bg-white">
            {/* Search Bar */}
            ...
            <div id="icons-container" className="flex items-center space-x-4">
                ...
                <div id="notification-icon" className="relative p-3 bg-blue-100 rounded-2xl text-blue-500 cursor-pointer">
                    ...
                    -translate-y-1/2 bg-blue-200 rounded-full px-2 py-1 text-xs text-blue-700">
                        50
                    </span>
                </div>
                ...
                <div id="settings-icon" className="p-3 bg-red-100 rounded-2xl text-red-500 cursor-pointer text-xl">
                    <SlSettings />
                </div>
                {/* Profile Section */}
                <div id="profile-container" className="flex items-center space-x-4 border-l pl-4 border-gray-300">
                    <span id="profile-text" className="text-gray-700">
                        Hello, <b className="text-gray-900">Ayu Nur Habibah</b>
                    </span>
                    <img
                        id="profile-avatar"
